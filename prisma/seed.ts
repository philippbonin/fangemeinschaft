...
async function seed() {
  try {
    ...
    const players = [
      { name: 'Max Müller', number: 1, position: 'Goalkeeper', image: '/players/max-mueller.jpg' },
      { name: 'Thomas Schmidt', number: 2, position: 'Defender', image: '/players/thomas-schmidt.jpg' },
      { name: 'Lars Weber', number: 4, position: 'Defender', image: '/players/lars-weber.jpg' }
    ];
